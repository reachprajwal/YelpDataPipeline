...
public class KafkaConsumerYelpBusinessAttribute {
    public static void main(String[] args) {
        ...
        con.subscribe(Arrays.asList("yelpBusinessAttribute"));
        ConsumerRecords<String, String> conRec = null;
        BufferedWriter writer = null;
        try {
            writer = new BufferedWriter(new FileWriter(new File("/home/yelp_business_attributes.csv")));
            while (true) {
                {
                    conRec = con.poll(100);
