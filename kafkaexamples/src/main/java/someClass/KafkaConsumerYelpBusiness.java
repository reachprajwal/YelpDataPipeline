...
public class KafkaConsumerYelpBusiness {
    public static void main(String[] args) {
        ...
        con.subscribe(Arrays.asList("yelpBusiness"));
        ConsumerRecords<String, String> conRec = null;
        BufferedWriter writer = null;
        try {
            writer = new BufferedWriter(new FileWriter(new File("/home/yelp_business.csv")));
            while (true) {
                {
                    conRec = con.poll(100);
