...
public class KafkaProducerYelpUser {
    public static void main(String[] args) {
        ...
        try
        {
             ...
             */
            csvReader = new CSVReader(new FileReader("/kafka/yelp_user.csv"),',','"',0);
        ...
        for(String lineToken: list){
            ...
            ProducerRecord<String,String> prodRec =
                    new ProducerRecord<String, String>("yelpUser",Integer.toString(key),lineToken);
            prod.send(prodRec);
        }
        prod.close();
