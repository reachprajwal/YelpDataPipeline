...
public class KafkaProducerYelpBusinessAttribute {
    public static void main(String[] args) {
        ...
        try
        {
             ...
             */
            csvReader = new CSVReader(new FileReader("/kafka/yelp_business_attributes.csv"),',','"',0);
        ...
        for(String lineToken: list){
            ...
            ProducerRecord<String,String> prodRec =
                    new ProducerRecord<String, String>("yelpBusinessAttribute",Integer.toString(key),lineToken);
            prod.send(prodRec);
        }
        prod.close();
