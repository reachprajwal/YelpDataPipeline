...
public class KafkaConsumerYelpBusinessHours {
    public static void main(String[] args) {
        ...
        con.subscribe(Arrays.asList("yelpBusinessHours"));
        ConsumerRecords<String, String> conRec = null;
        BufferedWriter writer = null;
        try {
            writer = new BufferedWriter(new FileWriter(new File("/home/yelp_business_hours.csv")));
            while (true) {
                {
                    conRec = con.poll(100);
