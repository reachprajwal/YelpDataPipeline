...
public class KafkaProducerYelpCheckin {
    public static void main(String[] args) {
        ...
        try
        {
             ...
             */
            csvReader = new CSVReader(new FileReader("/kafka/yelp_checkin.csv"),',','"',0);
        ...
        for(String lineToken: list){
            ...
            ProducerRecord<String,String> prodRec =
                    new ProducerRecord<String, String>("yelpCheckin",Integer.toString(key),lineToken);
            prod.send(prodRec);
        }
        prod.close();
    }
