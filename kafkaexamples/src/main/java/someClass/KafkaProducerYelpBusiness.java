...
public class KafkaProducerYelpBusiness {
    public static void main(String[] args) {
        ...
        try
        {
             ...
             */
            csvReader = new CSVReader(new FileReader("/kafka/yelp_business.csv"),',','"',0);
        ...
        for(String lineToken: list){
            ...
            ProducerRecord<String,String> prodRec =
                    new ProducerRecord<String, String>("yelpBusiness",Integer.toString(key),lineToken);
            prod.send(prodRec);
        }
        prod.close();
